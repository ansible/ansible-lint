...
!!! warning "Recovering clobbered collections"
    ...
    `~/.ansible/collections/...` start with
    `# This is a mocked Ansible module generated by ansible-lint`, reinstall
    the affected collections with `ansible-galaxy collection install ... --force`.
