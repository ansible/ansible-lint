...
@pytest.fixture
def yaml_formatting_fixture_before(fixture_filename: str) -> Tuple[Path, str, CommentedMap]:
...
@pytest.fixture
def yaml_formatting_fixture_after(fixture_filename: str) -> Tuple[Path, str, CommentedMap]:
