...
install custom rules since v4.3.1. The custom rules which is packaged as an
...
section of the *setup.cfg* of your custom rules python package like the followoing.
